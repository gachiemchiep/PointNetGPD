...
def worker(i, sample_nums, grasp_amount, good_grasp):
    ...
    yaml_config = YamlConfig(home_dir + "/workspace/2021_grasping/PointNetGPD/dex-net/test/config.yaml")
    gripper_name = 'robotiq_85'
    gripper = RobotGripper.load(gripper_name, home_dir + "/workspace/2021_grasping/PointNetGPD/dex-net/data/grippers")
...
if __name__ == '__main__':
    ...
    file_dir = "/datadrive/datasets/grasping/PointNetGPD/ycb_meshes_google/objects"
